...
pfType1Met = n.zeros(1, dtype=float)
...
Bkg.Add(Dir_mc+"latino_ZZTo2L2Nu.root")
Bkg.Add(Dir_mc+"latino_WZTo3LNu.root")
...
for chain in chains:
  ...
  #  print "Event%d" % iEvt
    goodLeptons = e.std_vector_lepton_pt[0]>20. and e.std_vector_lepton_pt[1]>15. and e.std_vector_lepton_pt[2]<10
    isOF = e.std_vector_lepton_flavour[0] * e.std_vector_lepton_flavour[1] == -11*13 and e.mll>12
    isSF = (e.std_vector_lepton_flavour[0] * e.std_vector_lepton_flavour[1] == -13*13 or e.std_vector_lepton_flavour[0] * e.std_vector_lepton_flavour[1] == -11*11 ) and e.mll>80 and e.mll < 110

    if not ( goodLeptons and (isOF or isSF) and e.trigger == 1): continue
    #((e.std_vector_lepton_flavour[0] * e.std_vector_lepton_flavour[1] == -11*13 ) or (e.std_vector_lepton_flavour[0] * e.std_vector_lepton_flavour[1] == -11*13 )) and  e.mll>12 and e.std_vector_lepton_pt[0]>20. and e.std_vector_lepton_pt[1]>15. and e.std_vector_lepton_pt[2]<10. and e.pfType1Met>20. and  e.trigger == 1) : continue
    ...
    if ( e.std_vector_jet_pt[0]>15 and e.std_vector_jet_csvv2ivf[0]>loose ) :
      tag += weight[0]
    ...
    if ( e.std_vector_jet_pt[1]>15 and e.std_vector_jet_csvv2ivf[1]>loose ) :
      tag += weight[0]
