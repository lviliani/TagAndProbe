...
// Set a bunch of parameters to make the plot look nice
  ...
  */
  ...
  // Define the model
  RooRealVar jetpttag("jetpttag", "jetpttag", 15, 150);
 ...
 // RooBinning binning(8, binning_a);
  //double binning_a[14] = {30, 40, 50, 60, 70, 80, 90, 100, 110, 120, 130, 140, 150, 200};
  ...
  RooRealVar s("s","signal yield",0,2000000);
  RooRealVar b("b","background yield",0,8000000);
  ...
  RooDataSet* data = new RooDataSet("data", "data",  RooArgSet(jetptprobe, jetpttag, weight, mll, passprobe_cat, isb, btagtag), Import(*tree_data), WeightVar(weight), Cut(mll_cut+" && isb==0"));

  // Import TTbar and Bkg datasets
  //signal: the probe is a b
  RooDataSet* ttbar_pp = new RooDataSet("ttbar_pp", "ttbar_pp", RooArgSet(jetptprobe, jetpttag, weight, mll, passprobe_cat, isb, btagtag), Import(*tree_ttbar), WeightVar(weight), Cut(mll_cut+" && passfail==1 && isb==1"));
  RooDataSet* ttbar_fp = new RooDataSet("ttbar_fp", "ttbar_fp", RooArgSet(jetptprobe, jetpttag, weight, mll, passprobe_cat, isb, btagtag), Import(*tree_ttbar), WeightVar(weight), Cut(mll_cut+" && passfail==0 && isb==1"));

  RooDataSet* ttbar_pp2 = new RooDataSet("ttbar_pp2", "ttbar_pp", RooArgSet(jetptprobe, jetpttag, weight, mll, passprobe_cat, isb, btagtag), Import(*tree_bkg), WeightVar(weight), Cut(mll_cut+" && passfail==1 && isb==1"));
  RooDataSet* ttbar_fp2 = new RooDataSet("ttbar_fp2", "ttbar_fp", RooArgSet(jetptprobe, jetpttag, weight, mll, passprobe_cat, isb, btagtag), Import(*tree_bkg), WeightVar(weight), Cut(mll_cut+" && passfail==0 && isb==1"));

  ttbar_pp->append(*ttbar_pp2);
  ttbar_fp->append(*ttbar_fp2);
  
  //background: the probe is not a b
  RooDataSet* otherbkg_pp = new RooDataSet("otherbkg_pp", "otherbkg_pp", RooArgSet(jetptprobe, jetpttag, weight, mll, passprobe_cat, isb, btagtag), Import(*tree_bkg), WeightVar(weight), Cut(mll_cut+" && passfail==1 && isb==0"));
  RooDataSet* otherbkg_fp = new RooDataSet("otherbkg_fp", "otherbkg_fp", RooArgSet(jetptprobe, jetpttag, weight, mll, passprobe_cat, isb, btagtag), Import(*tree_bkg), WeightVar(weight), Cut(mll_cut+" && passfail==0 && isb==0"));
 
  RooDataSet* otherbkg_pp2 = new RooDataSet("otherbkg_pp2", "otherbkg_pp2", RooArgSet(jetptprobe, jetpttag, weight, mll, passprobe_cat, isb, btagtag), Import(*tree_ttbar), WeightVar(weight), Cut(mll_cut+" && passfail==1 && isb==0"));
  RooDataSet* otherbkg_fp2 = new RooDataSet("otherbkg_fp2", "otherbkg_fp2", RooArgSet(jetptprobe, jetpttag, weight, mll, passprobe_cat, isb, btagtag), Import(*tree_ttbar), WeightVar(weight), Cut(mll_cut+" && passfail==0 && isb==0"));
